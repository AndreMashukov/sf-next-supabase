...
describe('CreateDocumentUseCase', () => {
  it('still completes the job when knowledge indexing fails', async () => {
    ...
    const knowledgeIndexer = {
      indexDocument: vi.fn().mockRejectedValue(new Error('Together embeddings request failed: 500')),
    };
    ...
    expect(generationJobRepository.markFailed).not.toHaveBeenCalled();
